...
from .util import exists, default, count_params, instantiate_from_config, make_beta_schedule, extract_into_tensor, noise_like
...
class DDPM(nn.Module):
    ...
    def forward_loss(self, x, *args, **kwargs):
